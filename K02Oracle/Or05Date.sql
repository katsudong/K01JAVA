...
select
    ...
    MONTHS_BETWEEN(SYSDATE, to_date('2020년1월1일', 'yyyy"년"mm"월"dd"일"'))"결과2",
    round(MONTHS_BETWEEN(SYSDATE, to_date('2020년1월1일', 'yyyy"년"mm"월"dd"일"')))"결과3"
from dual;
...
*/
select last_day('21/02/01') from dual; --28일출력
