...
class Sum
{
	...
	//메소드 호출 시 전달되는 매개변수의 값을 누적해서 더한다.
...
Thread 클래스를 생성하는 두번째 방법
	: Java는 다중상속이 지원되지 않으므로, 다른 클래스를 상속받아야 한다면
	Runnable 인터페이스를 구현해서 쓰레드 클래스를 정의해야한다.
 */
class AdderThread extends Sum implements Runnable
{
	...
	누적합을 구한다. start가 1이고 end가 10이라면 1~10까지의 합을 구하게된다.
	 */
	@Override
	public void run()
	{
...
public class Ex04Runnable
{
	public static void main(String[] args)
	{
		...
		쓰레드를 생성한다. 해당 방법도 결국은 Thread 클래스를 통해서 쓰레드를
		생성하게 된다.
		 */
