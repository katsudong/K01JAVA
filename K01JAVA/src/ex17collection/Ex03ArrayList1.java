...
-Array라는 이름처럼 '배열'의 특성을 가지고있어, 'index'를 통한 거장 및 접근이
가능하다.
 */
public class Ex03ArrayList1
{
	public static void main(String[] args)
	{
		...
		System.out.println("중복 저장 전 객체수: "+ list.size());//6개 출력
		...
		1-6] 포함여부확인
			...
			만약 포함되어있다면 true를 반환한다. 위치한 인덱스까지는 확인할 수 없다.
		 */
		...
		방법1 : 인덱스로 삭제한다. 삭제가 완료되면 삭제된 객체를 반환한다.
				그리고 삭제 후에는 인덱스가 자동적으로 재부여된다.
				삭제 성공 시 해당 객체를 반환하므로 어떤 객체를 삭제했는지 
				확인할 수 있다.
		 */
		...
		//방법2 : indexOf()메소드로 인덱스를 확인한 후 삭제한다.
