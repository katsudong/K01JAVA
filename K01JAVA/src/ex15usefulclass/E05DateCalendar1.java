...
public class E05DateCalendar1
{
	...
	/*
	Calendar 클래스를 통해 얻은 객체로 현재시간을 초로 반환받은 후
	...
	public static String[] myDiffDate() throws ParseException
	{
		 ...
		 */
		long diffSec = (formatFuture.getTime() - formatToday.getTime()) / 1000; //초
		long diffMin = (formatFuture.getTime() - formatToday.getTime()) / 60000; //분
		long diffHor = (formatFuture.getTime() - formatToday.getTime()) / 3600000; //시간
	...
	public static void main(String[] args) throws ParseException
	{
		...
		//Calendar 클래스는 대표적인 싱글톤이므로 new를 생성하지 않는다.
