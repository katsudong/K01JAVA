...
public class E06Random
{
	public static void main(String[] args)
	{
		...
		만약 seed값이 동일하다면 항상 같은 패턴의 난수만 생성하게되는데
		...
		{
			/*
			nextInt()의 인자값 100이 전달되면 0~99 사이의 난수가 생성된다.
			 */
		...
		//현재 시간을 밀리 초 단위로 반환하는 메소드를 통해 seed를 설정한다.
		...
		System.out.println("### 난수생성4 : 항상 다른 seed를 사용, nextInt() 인자 없음");
