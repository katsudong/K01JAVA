...
/*
	...
	: 예외발생과 상관없이 try문에 진입했을 때 반드시 실행해야 할 코드가
	있는 경우 기술하는 블록이다.
...
{
	/*
	런타임 예외가 발생되는 메소드. 예외 발생 시 무시하기 위해 throws하고있다.
	하지만 이와같은 예외는 어디서든 반드시 예외처리해야한다.
	 */
	...
	static void tryCatchFinally()
	{
		...
		try
		{
			age = scan.nextInt(); //<= 30살과 같이 입력하면 예외 발생
	...
	{
		/*
		만약 이 지점에서도 예외던지기를 하면 프로그램은 즉시 중지된다.
		즉 반드시 처리해야 할 예외가 존재한다.
		 */
		try
		{
			runtime();
